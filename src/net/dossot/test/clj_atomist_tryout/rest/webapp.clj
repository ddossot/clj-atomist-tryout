(ns net.dossot.test.clj-atomist-tryout.rest.webapp
  (:require [clojure.tools.logging :as log]
            [com.stuartsierra.component :as component]
            [compojure.api.sweet :refer :all]
            [ring.util.http-response :refer :all]
            [schema.core :as s])
  (:require [net.dossot.test.clj-atomist-tryout.models.status :as m-status]
            [net.dossot.test.clj-atomist-tryout.rest.status :as status]))
